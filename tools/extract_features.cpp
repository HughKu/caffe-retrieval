...
int feature_extraction_pipeline(int argc, char** argv) {
  ...
  /* DEBUG -> show the number of features @Wei-Lin */
  LOG(ERROR) << "Number of features = " << num_features;
  ...
  for (int batch_index = 0; batch_index < num_mini_batches; ++batch_index) {
    ...
    for (int i = 0; i < num_features; ++i) {
      ...
      for (int n = 0; n < batch_size; ++n) {
        ...
        /* DEBUG -> display datum  @Wei-Lin*/
        std::cout << "=============================================================" << std::endl;
        std::cout << "num_mini_batches: " << batch_index << "/" << num_mini_batches << std::endl;
        std::cout << "num_features: " << i << "/" << num_features << std::endl;
        std::cout << "batch_size: " << n << "/" << batch_size << std::endl;
        std::cout << "=============================================================" << std::endl;
        listDatum(datum);
